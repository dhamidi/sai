...

{
    ...
    */
    ...
    HeapFloatBuffer(int cap, int lim, MemorySegment segment) {            // package-private
    ...
    HeapFloatBuffer(float[] buf, int off, int len, MemorySegment segment) { // package-private
