...

{
    ...
    */
    ...
    HeapLongBuffer(int cap, int lim, MemorySegment segment) {            // package-private
    ...
    HeapLongBuffer(long[] buf, int off, int len, MemorySegment segment) { // package-private
