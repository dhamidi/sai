...

{
    ...
    */
    ...
    HeapDoubleBuffer(int cap, int lim, MemorySegment segment) {            // package-private
    ...
    HeapDoubleBuffer(double[] buf, int off, int len, MemorySegment segment) { // package-private
