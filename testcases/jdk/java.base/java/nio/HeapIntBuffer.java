...

{
    ...
    */
    ...
    HeapIntBuffer(int cap, int lim, MemorySegment segment) {            // package-private
    ...
    HeapIntBuffer(int[] buf, int off, int len, MemorySegment segment) { // package-private
