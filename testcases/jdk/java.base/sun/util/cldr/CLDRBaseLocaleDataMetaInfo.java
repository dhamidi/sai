...
public class CLDRBaseLocaleDataMetaInfo implements LocaleDataMetaInfo {
    ...
    static {
        ...
        parentLocalesMap.put(Locale.forLanguageTag("en-150"),
            new String[] {
                "en-AT", "en-BE", "en-CH", "en-CZ", "en-DE", "en-DK", "en-ES", "en-FI", 
                "en-FR", "en-HU", "en-IT", "en-NL", "en-NO", "en-PL", "en-PT", "en-RO", 
                "en-SE", "en-SI", "en-SK", 
            });
    ...
    private static class CLDRMapHolder {
        ...
        static {
            ...
            likelyScriptMap.put("Ogam", " pgl xpi ");
